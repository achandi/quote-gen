/* Amplify Params - DO NOT EDIT
	...
	API_QUOTEGEN_QUOTEAPPDATATABLE_ARN
	API_QUOTEGEN_QUOTEAPPDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
/**
...
async function updateQuoteDDBObject() {
  const quoteTableName = process.env.API_QUOTEGEN_QUOTEAPPDATATABLE_NAME;
  const quoteObjectId = "b38075ba-8b5e-4a76-baaf-88ce072ea851";
  ...
  try {
    ...
    console.log("error updating DynamoDB quote object", err);
  }
}
  ...
  async function getRandomQuote(apiURLInput) {
    ...
    const svgImage = `
        <svg width="${width}" height="${height}">
            ...
            <text x="${width / 2}" y="${
      height - 10
    }" class="footerStyles">Developed by @achandi | Quotes from ZenQuotes.io</text>
        </svg>
      `;
