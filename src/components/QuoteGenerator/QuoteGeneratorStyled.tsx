...
export const BackgroundImageFirst = styled(Image)`
  position: relative;
  z-index: 1;
  margin-left: -10px;
  margin-top: -10px;
...
export const BackgroundImageSecond = styled(Image)`
  position: fixed;
  z-index: 1;
  right: -120px;
  bottom: -10px;
...
export const QuoteGeneratorContainer = styled.div`
  ...
  transform: translate(
    -50%,
    -50%
  ); //to get it exactly in the center (with 2 previous styles + position absolute below)
  position: absolute;
  z-index: 2;
  //below using https://hype4.academy/tools/glassmorphism-generator
  background: rgba(0, 0, 70, 0.3);
  box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.37); //glassy effect
